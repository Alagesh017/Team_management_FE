...
function normalizeUrlForComparison(url, logger, correlationId) {
  ...
  try {
    ...
    logger == null ? void 0 : logger.error("15apdm", correlationId || "");
...
function validateUrl(url, logger, correlationId) {
  try {
    ...
    logger == null ? void 0 : logger.error("1lrjz7", correlationId || "");
    throw createClientConfigurationError(urlParseError);
  }
}
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-WN3A3DZG.js");
    }
  } catch (e) {
  }
  return void 0;
