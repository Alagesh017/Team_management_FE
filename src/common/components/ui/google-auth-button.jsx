...
export const GoogleAuthButton = ({ onSuccess, onError, text = "Continue with Google" }) => {
  ...
  return (
    <div className="relative p-[1.5px] rounded-md overflow-hidden w-full group transition-all duration-300">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#4285F4] via-[#EA4335] via-[#FBBC05] to-[#34A853] animate-gradient-x opacity-70 group-hover:opacity-100 transition-opacity"></div>
