    ...
    <ContextMenu content={contextContent}>
      ...
      >
        ...
        <div className="w-full text-center max-w-[140px] mt-1">
          <span 
            className="text-[13px] font-medium text-slate-600 leading-tight line-clamp-2 break-all transition-colors group-hover:text-slate-900"
            title={project.name}
          >
            {project.name}
          </span>
    ...
    <div className="p-6 space-y-8 bg-white min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b pb-6">
        <div className="space-y-1">
          ...
          <p className="text-sm text-slate-500 font-medium">Browse and manage your project directories.</p>
        </div>
